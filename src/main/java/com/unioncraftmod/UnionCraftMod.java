...
@Mod(UnionCraftMod.MOD_ID)
public class UnionCraftMod
{
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "unioncraftmod";
    // Directly reference a slf4j logger
    private static final Logger LOGGER = LogUtils.getLogger();

    public UnionCraftMod(FMLJavaModLoadingContext context)
    {
